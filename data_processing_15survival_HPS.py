...
ld['fail'] = np.where((ld['DEATH_DATE'].isnull() == False) & (ld['TX_DATE'].isnull() == True) & ld[f'EXC_DIAG_ID_CAT3'] == 1, 1, 0)
...
features = pd.read_csv('waitlist_features_HPS.csv')
...
ld_reduced.to_hdf('LIVER_DATA_15survival_HPS.hdf5', key = 'df')
